// Office table-tennis ladder — CLOUD ledger (Supabase), shared by the live
// Table Tennis HQ site and the local Reconciliation HQ site. The match log is
...
// Ladder admins (player ids): may delete matches, add players, and run the
// triple-approval player deletion. Submitting a match is broader — any player
// whose can_submit flag is true (everyone except Caleb & Dillon).
